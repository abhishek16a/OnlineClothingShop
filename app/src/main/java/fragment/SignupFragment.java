...
public class SignupFragment extends Fragment implements View.OnClickListener {
    ...
    private EditText Username_Signup,Password_Signup,etConfPass;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Username_Signup=view.findViewById(R.id.etUsername_Signup);
        Password_Signup=view.findViewById(R.id.etPasword_Signup);
    ...
    private void Register() {
        ...
        if (pass1.equals(pass2)) {
            editor.putString("username", Username_Signup.getText().toString());
    ...
    public Boolean validate(){
        ...
        if(TextUtils.isEmpty(Username_Signup.getText().toString())){
            Username_Signup.setError("Please Enter Username");
            Username_Signup.requestFocus();
            isValid=false;
        }else if (TextUtils.isEmpty(Password_Signup.getText().toString())){
